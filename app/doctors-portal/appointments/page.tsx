...
import AppwriteAppiontments, { AppointmentType } from '@/appwrite/appiontment';
import patients from '@/appwrite/patients';
import doctors from '@/appwrite/doctors';
...
interface appointmentType extends AppointmentType {
  patientName: string;
  patientAvatar: string;
  contact: {
    phone: string;

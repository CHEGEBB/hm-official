...
const mockAppointments: Appointment[] = [
  {
    ...
    type: 'Check-up',
    status: 'Confirmed',
    patientAvatar: '/assets/images/13.png',
  },
  {
    id: 2,
    patient: 'Mitchelle Chang',
    time: '10:30 AM',
    type: 'Follow-up',
    status: 'Pending',
  ...
  },
  {
    ...
    type: 'Emergency',
    status: 'Confirmed',
    patientAvatar: '/assets/images/14.png',
  },
];
...
const mockActivity: ActivityLog[] = [
  {
    id: 1,
    time: '10:30 AM',
    text: 'Updated patient records for Jane Cooper',
    type: 'update',
  },
  {
    id: 2,
    time: '09:15 AM',
    text: 'Prescribed medication for Wade Warren',
    type: 'prescription',
  },
  {
    id: 3,
    time: '08:00 AM',
    text: 'Started morning consultations',
    type: 'consultation',
  },
  {
    id: 4,
    time: 'Yesterday',
    text: 'Completed weekly patient reviews',
    type: 'review',
  },
];
              ...
              <CardContent>
                <div className='relative pl-6 space-y-6'>
                  ...
                  {mockActivity.map((activity) => (
                    ...
                    >
                      <div
                        className={`absolute -left-[23px] w-4 h-4 rounded-full ${
